...
const tiers = [
  ...
  },
  {
    ...
    features: ['500,000 traces / month', 'Unlimited projects', '30-day retention', 'Priority support', 'Usage-based overages'],
  ...
  },
  {
    ...
    features: ['Unlimited traces', 'SSO & RBAC', 'Custom retention', 'Private region deployment', 'Dedicated support'],
    cta: 'Contact sales',
    featured: false,
    action: 'contact',
  },
    ...
    <section id="pricing" className="py-24 border-b border-neutral-800">
      <div className="max-w-[1100px] mx-auto px-8">
        <div className="max-w-[560px] mb-14">
          <div className="text-[11px] font-medium uppercase tracking-[1.5px] text-neutral-600 mb-4">Pricing</div>
          <h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          {tiers.map((tier) => (
            ...
            >
              <div className="text-[11px] font-medium uppercase tracking-[1.5px] text-neutral-600 mb-4">{tier.name}</div>
              <div className="mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '-0.03em' }}>
              ...
              <p className="text-sm text-neutral-500 mb-7 pb-7 border-b border-neutral-800">{tier.desc}</p>
              <ul className="flex-1 flex flex-col gap-3 mb-8">
                {tier.features.map((f) => (
                  <li key={f} className="text-sm text-neutral-500 pl-5 relative before:content-['—'] before:absolute before:left-0 before:text-neutral-600">{f}</li>
                ))}
              </ul>
              {tier.action === 'signup' && (
                <Link
